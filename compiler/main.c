...
int main(int argc, char *argv[]) {
    ...
    /* ── Stage 7: Complexity ─────────────────────── */
    ComplexityResult cx = complexity_analyze(ar.root);

    /* ── Stage 8: Hotspots ───────────────────────── */
    HotspotResult hs = hotspot_detect(ar.root, &st);
    ...
    /* complexity */
    buf_append(&out, ",\"complexity\":");
    complexity_to_json(&cx, &out);

    /* hotspots */
    buf_append(&out, ",\"hotspots\":");
    hotspot_to_json(&hs, &out);
