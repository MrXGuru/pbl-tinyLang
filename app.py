...
def compile_code():
    ...
    if not compiler_path:
        return jsonify({
            ...
            'symbol_table': [], 'optimizer': {}, 'complexity': {},
            'hotspots': [], 'compile_time_ms': 0,
        })
    ...
    try:
        ...
        try:
            ...
            return jsonify({
                ...
                'tokens': [], 'parse_table': {}, 'ast': {},
                'symbol_table': [], 'optimizer': {}, 'complexity': {},
                'hotspots': [], 'compile_time_ms': 10000,
            })
    ...
    if proc.returncode != 0:
        ...
        return jsonify({
            ...
            'tokens': [], 'parse_table': {}, 'ast': {},
            'symbol_table': [], 'optimizer': {}, 'complexity': {},
            'hotspots': [], 'compile_time_ms': elapsed_ms,
        })
